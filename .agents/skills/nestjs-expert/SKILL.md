...
For TypeScript style and modeling, apply `typescript-best-practices`. For TypeScript major-version upgrades, use `typescript-migration`. Do not restate those rules here.

### When invoked:

0. If a more specialized expert fits better, recommend switching and stop:
   - Pure TypeScript style/types → typescript-best-practices
   - TypeScript major-version upgrades → typescript-migration
   - Database query optimization → database-expert / supabase-postgres-best-practices
   - Frontend React / Next.js → next-js-expert

   Example: "This is a TypeScript type-system issue. Apply typescript-best-practices. Stopping here."
